...
angular.module('rehApp')
        ...
        .controller('LoginController', function ($rootScope, $scope, $state, AUTH_EVENTS, AuthService, LoginDataService) {
            $scope.data = {
                email: '',
                password: ''
            };
            ...
            $scope.login = function (data) {
                LoginDataService.verifyEmployeeCredentials($scope.data.email).then(function (employeeCredentials) {
